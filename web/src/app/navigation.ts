...
const baseNavigationGroups: NavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/account-groups', label: '上游账号组/凭证池', icon: TablePropertiesIcon },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/access-groups', label: '权益/授权组', icon: ShieldCheckIcon, end: true },
      { to: '/subscriptions', label: '订阅关系', icon: ShieldIcon, end: true },
      { to: '/announcements', label: '公告中心', icon: AppWindowIcon, end: true },
      { to: '/invitation-codes', label: '邀请码', icon: KeyRoundIcon, end: true },
...
const routeMeta: RouteMeta[] = [
  ...
  {
    patterns: ['/invitation-codes'],
    title: '邀请码',
    groupLabel: '用户与计费',
    navTo: '/invitation-codes',
  },
  {
