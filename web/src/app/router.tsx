...
const consoleChildren = [
  ...
  { path: 'provider-sites', element: <Navigate to="/console/models" replace /> },
  { path: 'provider-sites/new', element: <Navigate to="/console/models" replace /> },
  { path: 'provider-sites/new/settings', element: <Navigate to="/console/models" replace /> },
  { path: 'provider-sites/:id', element: <Navigate to="/console/models" replace /> },
  { path: 'provider-sites/:id/settings', element: <Navigate to="/console/models" replace /> },
  { path: 'capability-matrix', element: <Navigate to="/console/models" replace /> },
