...
describe('ProviderSiteDetailPage', () => {
  it('filters capabilities by feature and saves edits', async () => {
    ...
    expect(screen.getByText(/acceptedException \/ blockerReasons: response object fallback/)).toBeInTheDocument()
    ...
    expect(screen.getByRole('link', { name: '查看 Trace' })).toHaveAttribute('href', expect.stringContaining('/ops/logs?providerType=GEMINI_DIRECT'))
