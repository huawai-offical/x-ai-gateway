...
- 不实现 Vector Stores，交由 `023`；Containers 不属于当前功能性服务 API 必做范围。
...
- 任意未知远端 `resp_...` id 的无 hint 盲路由保持非目标；真实 OpenAI Direct Responses smoke 由 [TASK-20260514-031](../backlog/TASK-20260514-031-openai-real-smoke-certification-harness.md) 的受控 key/预算/record-replay 体系继续承接。

## 当前状态

- 2026-05-21：Responses native create、stream、生命周期、input_tokens/compact 与 route hint 均已由下游切片闭环；本任务归档至 `tasks/done/`。
