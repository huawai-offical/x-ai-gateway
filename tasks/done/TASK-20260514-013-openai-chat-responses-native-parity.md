...
- 本任务已由下游 done 子任务提供 mapper/runtime、controller、docs 和 OpenAPI 证据。
- 真实 OpenAI key smoke 不作为本任务继续阻塞项，统一交由 [TASK-20260514-031](../backlog/TASK-20260514-031-openai-real-smoke-certification-harness.md)。
...
- 2026-05-21：功能性服务 API 范围内的 Chat/Responses 主体已由下游任务闭环；剩余真实 smoke 统一交由 `TASK-20260514-031`，本任务归档至 `tasks/done/`。
