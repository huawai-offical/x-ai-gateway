...
- 无当前开发切片。Chat create 复杂对象 typed mapping、参数级 conformance/docs/SDK 证明、stored Chat lifecycle 与数据库游标分页均已闭环。
- 真实 smoke 证据统一交由 [TASK-20260514-031](../backlog/TASK-20260514-031-openai-real-smoke-certification-harness.md)，不再让本任务停留在 Backlog。

## 当前状态

- 2026-05-21：按功能性服务 API 范围归档至 `tasks/done/`。
